public class Main {
    ...
    public static void task8(){
        ...
        var totalHours = 640;
        var oneEmployee = 8;
        var totalEmpioyees = totalHours / oneEmployee;
        System.out.println("Всего работников в компании " + totalEmpioyees + " человек");
        var totalEmpioyees1 = totalEmpioyees + 94;
        var totalHours1 = totalHours / totalEmpioyees1;
        System.out.println("Если в компании работает " + totalEmpioyees1 + " человек, то всего " + totalHours1 + " часа работы может быть поделено между сотрудниками");
    }
}